    ...
    <>
      ...
      <ContactForm className={state.status === 'PENDING' ? 'form-pending' : ''}>
        ...
        {state.status !== 'ERROR' && (
          <div tw="flex-1 px-2 lg:px-10 m-auto lg:px-32">
            ...
            <p tw="flex pt-0 items-center">
              ...
              <span tw="m-0">
                <strong style={{color:colors.blue}}>Business:</strong> <a href={`mailto:${contact.email}`}>{contact.email}</a>
                <br />
                <strong style={{color:colors.blue}}>Career:</strong> <a href={`mailto:${contact.careerEmail}`}>{contact.careerEmail}</a>
              </span>
            </p>
        ...
        <form name="Booking" onSubmit={handleSubmit} tw="flex-1 px-2 pt-10 lg:px-32 lg:pt-0">
          ...
          <Button type="submit" style={{backgroundColor:colors.blue,color: colors.white}}>Submit</Button>
        </form>
      </ContactForm>
    </>
  )
