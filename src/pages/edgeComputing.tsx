...
`
export default function edgeComputing(): JSX.Element {
  ...
  return (
    ...
    <Layout>
     ...
     <Accord className={services[5].flip ? 'flipper' : ''}  onClick={() => {
                services[5].flip=true
                setServices([...services])
                console.log(services[5])
                }}
                
                onMouseLeave={() => {
                    services[5].flip=false
                    setServices([...services])
              ...
              <Container>
                <Front>
                  <img tw="m-auto w-40 mt-8 mb-6" src={services[5].featuredImage.src} />
                  <Title>{services[5].title}</Title>
                  {/* <p tw="py-2 text-center">{service.description}</p> */}
                </Front>
                <Back>
                  {/* <Title>{service.title}</Title> */}
                  <p tw="py-2 text-center">{services[5].longDescription}</p>
                </Back>
              </Container>
            </Accord>
