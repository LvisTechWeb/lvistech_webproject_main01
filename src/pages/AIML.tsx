...
`
export default function AIML(): JSX.Element {
  ...
  return (
    ...
    <Layout>
     ...
     <Accord className={services[4].flip ? 'flipper' : ''}  onClick={() => {
                services[4].flip=true
                setServices([...services])
                console.log(services[4])
                }}
                
                onMouseLeave={() => {
                    services[4].flip=false
                    setServices([...services])
              ...
              <Container>
                <Front>
                  <img tw="m-auto w-40 mt-8 mb-6" src={services[4].featuredImage.src} />
                  <Title>{services[4].title}</Title>
                  {/* <p tw="py-2 text-center">{service.description}</p> */}
                </Front>
                <Back>
                  {/* <Title>{service.title}</Title> */}
                  <p tw="py-2 text-center">{services[4].longDescription}</p>
                </Back>
              </Container>
            </Accord>
