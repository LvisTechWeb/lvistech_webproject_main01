...
`
export default function DataScience(): JSX.Element {
  ...
  return (
    ...
    <Layout>
     ...
     <Accord className={services[0].flip ? 'flipper' : ''}  onClick={() => {
                services[0].flip=true
                setServices([...services])
                console.log(services[0])
                }}
                
                onMouseLeave={() => {
                    services[0].flip=false
                    setServices([...services])
              ...
              <Container>
                <Front>
                  <img tw="m-auto w-40 mt-8 mb-6" src={services[0].featuredImage.src} />
                  <Title>{services[0].title}</Title>
                  {/* <p tw="py-2 text-center">{service.description}</p> */}
                </Front>
                <Back>
                  {/* <Title>{service.title}</Title> */}
                  <p tw="py-2 text-center">{services[0].longDescription}</p>
                </Back>
              </Container>
            </Accord>
