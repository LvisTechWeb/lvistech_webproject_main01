...
`
export default function blockChainIot(): JSX.Element {
  ...
  return (
    ...
    <Layout>
     ...
     <Accord className={services[1].flip ? 'flipper' : ''}  onClick={() => {
                services[1].flip=true
                setServices([...services])
                console.log(services[1])
                }}
                
                onMouseLeave={() => {
                    services[1].flip=false
                    setServices([...services])
              ...
              <Container>
                <Front>
                  <img tw="m-auto w-40 mt-8 mb-6" src={services[1].featuredImage.src} />
                  <Title>{services[1].title}</Title>
                  {/* <p tw="py-2 text-center">{service.description}</p> */}
                </Front>
                <Back>
                  {/* <Title>{service.title}</Title> */}
                  <p tw="py-2 text-center">{services[1].longDescription}</p>
                </Back>
              </Container>
            </Accord>
